...
void memberOperations()
{
    ...
    vector<Member> memberList2 = readCSVMembers("./csv_files/members.csv");
    int choice;
    do
    {
        displayMenuMember();
        ...
        case 5:
            ...
            {
                std::ofstream myfile;
                std::ifstream file("./csv_files/members.csv");
                myfile.open("./csv_files/members.csv");
...
void bookOperations()
{
    vector<Book> bookList = readCSVBooks("./csv_files/books.csv");
    int choice;
...
int main()
{
    // create a menu to select between the following three options.
    // memberOperations();
    // bookOperations();
